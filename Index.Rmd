...
O R é cada vez mais integrado com os sistemas da *web*. Nesse caso, foi desenvolvida uma API para integrar as **ferramentas de Visualiza??o do Google no R**. Com isso, é possível fazer diversos gráficos modernos e interativos. No gráfico abaixo, por exemplo, podemos ver as Unidades de Pronto Atendimento - UPAS da cidade do Rio de Janeiro. Nesse tipo de visualização, também é possível ver a foto da frente/fachada de cada UPA.
